...
class RNCryptorTests: XCTestCase {
    ...
    func testKDF() {
        let password = "a"
        let salt = "0102030405060708".bytesFromHexString()!
        let key = RNCryptorV3.keyForPassword(password, salt: salt)
        let expect = "fc632b0c a6b23eff 9a9dc3e0 e585167f 5a328916 ed19f835 58be3ba9 828797cd".bytesFromHexString()!
    ...
    func testKeyEncryptor() {
        let encryptKey = "000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f".bytesFromHexString()!
        let hmacKey = "0102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f00".bytesFromHexString()!
        let iv = "02030405060708090a0b0c0d0e0f0001".bytesFromHexString()!
        let plaintext = "01".bytesFromHexString()!
        let ciphertext = "03000203 04050607 08090a0b 0c0d0e0f 0001981b 22e7a644 8118d695 bd654f72 e9d6ed75 ec14ae2a a067eed2 a98a56e0 993dfe22 ab5887b3 f6e3cdd4 0767f519 5eb5".bytesFromHexString()!
    ...
    func testPasswordEncryptor() {
        ...
        let encryptionSalt = "0001020304050607".bytesFromHexString()!
        let hmacSalt = "0102030405060708".bytesFromHexString()!
        let iv = "02030405060708090a0b0c0d0e0f0001".bytesFromHexString()!
        let plaintext = "01".bytesFromHexString()!
        let ciphertext = "03010001 02030405 06070102 03040506 07080203 04050607 08090a0b 0c0d0e0f 0001a1f8 730e0bf4 80eb7b70 f690abf2 1e029514 164ad3c4 74a51b30 c7eaa1ca 545b7de3 de5b010a cbad0a9a 13857df6 96a8".bytesFromHexString()!
